...
export class BuildingsController {
  ...
  @Patch(':id')
  @ApiOperation({ summary: 'Update a building (Admin: direct, Worker: creates change request)' })
  @ApiResponse({ status: 200, description: 'Building updated or change request created' })
  ...
  async update(
    ...
    return this.buildingsService.update(id, dto, userId, userRole === Role.ADMIN);
  }

...
export class NotificationsGateway implements OnGatewayConnection, OnGatewayDisconnect {
  ...
  handleJoin(@ConnectedSocket() client: AuthenticatedSocket, @MessageBody() data: { room: string }) {
    if (data.room) {
  ...
  handleLeave(@ConnectedSocket() client: AuthenticatedSocket, @MessageBody() data: { room: string }) {
    if (data.room) {

...
import { ApiTags, ApiOperation, ApiExcludeController, ApiResponse } from '@nestjs/swagger';
...
export class MonitoringController {
  ...
  @ApiResponse({ status: 200, description: 'System metrics', schema: { example: { uptime: 3600, requests: { total: 1250, errors: 5, avgResponseMs: 42 }, memory: { heapUsedMb: 85, heapTotalMb: 120, rssMb: 150 }, cpu: { user: 1200, system: 300 }, timestamp: '2025-01-15T10:30:00.000Z' } } })
  getMetrics() {

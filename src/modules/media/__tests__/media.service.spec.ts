...
describe('MediaService', () => {
  ...
  beforeEach(async () => {
    prisma = {
      media: {
        ...
        create: jest.fn().mockResolvedValue({ id: 'm-1', storageKey: 'image/test.jpg' }),
  ...
  describe('getDownloadUrl', () => {
    ...
    it('should return presigned download URL', async () => {
      prisma.media.findUnique.mockResolvedValue({ id: 'm-1', storageKey: 'image/test.jpg', originalFileName: 'photo.jpg' });

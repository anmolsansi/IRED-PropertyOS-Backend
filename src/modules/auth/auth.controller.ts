...
export class AuthController {
  ...
  @ApiResponse({ status: 200, description: 'OTP sent to email', schema: { example: { userId: 'uuid', email: 'user@example.com', requiresOtp: true, message: 'OTP sent to your email. Please verify to continue.' } } })
  ...
  @ApiResponse({ status: 200, description: 'Tokens issued', schema: { example: { accessToken: 'jwt...', refreshToken: 'jwt...', user: { id: 'uuid', email: 'user@example.com', fullName: 'John', role: 'WORKER' } } } })
  ...
  @ApiResponse({ status: 200, description: 'OTP resent', schema: { example: { message: 'OTP resent to your email' } } })
  ...
  @ApiResponse({ status: 200, description: 'New access token', schema: { example: { accessToken: 'jwt...', refreshToken: 'jwt...' } } })
  ...
  @ApiResponse({ status: 200, description: 'Reset OTP sent', schema: { example: { message: 'Password reset OTP sent to your email' } } })
  ...
  @ApiResponse({ status: 200, description: 'OTP sent to mobile', schema: { example: { message: 'OTP sent to your mobile number' } } })
  ...
  @ApiResponse({ status: 200, description: 'Mobile verified', schema: { example: { accessToken: 'jwt...', refreshToken: 'jwt...' } } })
  @ApiResponse({ status: 401, description: 'Invalid OTP' })
  ...
  @ApiResponse({ status: 200, description: 'Current user', schema: { example: { id: 'uuid', email: 'user@example.com', fullName: 'John Doe', role: 'WORKER', status: 'active', organizationId: 'uuid' } } })

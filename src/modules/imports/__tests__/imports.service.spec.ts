  ...
  beforeEach(async () => {
    prisma = {
      import: {
        ...
        findUnique: jest.fn().mockResolvedValue({ id: 'imp-1', status: 'uploaded', rows: [], creator: null, processor: null }),
        create: jest.fn().mockResolvedValue({ id: 'imp-1', status: 'uploaded' }),

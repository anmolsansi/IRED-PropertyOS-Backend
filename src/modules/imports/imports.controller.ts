...
export class ImportsController {
  ...
  @ApiResponse({ status: 200, description: 'Import list', schema: { example: { data: [{ id: 'uuid', fileName: 'buildings.csv', entityType: 'building', status: 'completed', createdAt: '2025-01-15T10:30:00.000Z' }], pagination: { page: 1, limit: 20, total: 5, totalPages: 1 } } } })
  async findAll() {
  ...
  @ApiResponse({ status: 201, description: 'File parsed', schema: { example: { id: 'uuid', fileName: 'buildings.csv', entityType: 'building', status: 'uploaded', totalRows: 50, validRows: 48, errorRows: 2 } } })
  ...
  @ApiResponse({ status: 200, description: 'Columns mapped', schema: { example: { id: 'uuid', status: 'mapped', columnMapping: { "Building Name": "name", "City": "cityId" } } } })
  ...
  @ApiResponse({ status: 200, description: 'Validation results', schema: { example: { id: 'uuid', status: 'validated', validRows: 48, errorRows: 2, errors: [{ row: 5, field: 'name', message: 'Required' }] } } })
  ...
  @ApiResponse({ status: 200, description: 'Import processed', schema: { example: { id: 'uuid', status: 'completed', importStats: { created: 48, updated: 0, failed: 2 } } } })
  async confirm(
    @Param('id') id: string,
    @CurrentUser('id') userId: string,
  ) {

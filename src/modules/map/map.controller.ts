...
export class MapController {
  ...
  @ApiResponse({ status: 200, description: 'Properties in bounds', schema: { example: { data: [{ id: 'uuid', name: 'Tower A', latitude: 19.076, longitude: 72.8777, totalUnits: 48, availabilityStatus: 'Available' }] } } })
  ...
  @ApiResponse({ status: 200, description: 'Nearby properties with distance', schema: { example: { data: [{ id: 'uuid', name: 'Tower A', latitude: 19.076, longitude: 72.8777, distance: 1.2 }] } } })
